...
const CreatePropertyPage = () => {
    ...
    const handleCreateOrUpdateProperty = async (event) => {
        ...
        try {
            ...
            if (editingProperty) {
                // Update property
                await axios.put(`http://localhost:3000/api/v1/properties/property/${editingProperty._id}`, formData, {
                    headers: {
                        Authorization: token
                    }
                });
                ...
                // Create new property
                await axios.post('http://localhost:3000/api/v1/properties/property', formData, {
                    headers: {
                        Authorization: token
                    }
                });
    ...
    return (
        <div>
            ...
            <button onClick={() => setShowCreateForm(!showCreateForm)}>
                {showCreateForm ? 'Cancel' : (editingProperty ? 'Update Property' : 'Create Property')}
            </button>
